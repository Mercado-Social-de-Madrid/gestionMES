...
from accounts.models import Category, Provider, Consumer, Colaborator
from core.forms.BootstrapForm import BootstrapForm
from management.models import Comission
from mes.settings import MEMBER_CONSUMER, MEMBER_COLAB
...
class CollaboratorForm(forms.ModelForm, BootstrapForm):
    ...
    class Meta:
        ...
        exclude = ['group', 'status', 'member_type', 'cr_member', 'registration_date', 'cyclos_user',
                   'bonus_percent_entity', 'bonus_percent_general', 'max_percent_payment', ]
