...
Menu.add_item("main", PermissionsMenuItem(_("Balance social"), '#',
          permissions=['payments.mespermission_can_view_payments',
                       'payments.mespermission_can_view_card_payments',
                       'payments.mespermission_can_view_payments',
                       'payments.mespermission_can_manage_sepa'
