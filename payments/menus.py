...
Menu.add_item("main",PermissionsMenuItem(_("Cuotas anuales"), reverse('payments:annual_feecharges', kwargs={'year':settings.CURRENT_FEECHARGES_YEAR}), weight=PAYMENTS_MENU_WEIGHT+10, icon="menu_book"))
