...
from payments.models import AccountAnnualFeeCharge, AnnualFeeCharges, PendingPayment, CONSUMERS, AutogeneratedAnnualFee
...
class AnnualFeeChargesList(PermissionRequiredMixin, FilterMixin, FilterView, ExportAsCSVMixin, AjaxTemplateResponseMixin):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['real_current_year'] = year = settings.CURRENT_FEECHARGES_YEAR

        context['are_consumers_annual_fees_autogenerated'] = AutogeneratedAnnualFee.objects.filter(
            year=year, account_type=CONSUMERS)
