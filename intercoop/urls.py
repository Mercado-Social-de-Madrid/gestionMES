...
urlpatterns = [
    ...
    url(r'^accounts/(?P<pk>[0-9a-f-]+)/validate/$', views.validate_account, name='validate_account'),
    url(r'^accounts/(?P<pk>[0-9a-f-]+)/delete/$', views.account_delete, name='account_delete'),
